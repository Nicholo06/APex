...
class ADBDumper:
    ...
    def pull_data(self):
        """Pulls sensitive data from protected directories using root hop with quoted commands"""
        ...
        try:
            # 1. Create a temporary world-readable directory on the device (Properly Quoted)
